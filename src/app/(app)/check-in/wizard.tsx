      ...
      <div className="mt-6 rounded-lg border border-ok/30 bg-ok-soft p-6">
        ...
        <div className="mt-4 flex gap-2">
          ...
          <button
            ...
            className="rounded-md border border-line bg-card px-4 py-2 text-sm text-muted hover:bg-paper"
          >
            Receive next line
          </button>
          <Link href="/inventory" className="rounded-md border border-line bg-card px-4 py-2 text-sm text-muted hover:bg-paper">
            Done
          </Link>
        </div>
      </div>
